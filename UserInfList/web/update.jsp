        ...
        <form action="${pageContext.request.contextPath}/updateUserServlet" method="post">
          ...
          <div class="form-group">
            <label>性别：</label>
              ...
              <c:if test="${user.gender == '女' or user.gender == 'fema'}">
          ...
          <div class="form-group">
            <label for="address">籍贯：</label>
             <select name="address" id="address" class="form-control" >
                 <c:if test="${user.address == '森林'}">
                     <option value="森林" selected>森林</option>
                     <option value="森岭">森岭</option>
                     <option value="地球">地球</option>
                 </c:if>

                 <c:if test="${user.address == '森岭'}">
                     <option value="森林">森林</option>
                     <option value="森岭" selected>森岭</option>
                     <option value="地球">地球</option>
                 </c:if>

                 <c:if test="${user.address == '诺克萨斯'}">
                     <option value="森林">森林</option>
                     <option value="森岭">森岭</option>
                     <option value="地球" selected>地球</option>
                 </c:if>
